...
import CatMainFind from "@/page/finder/FindCatPage.astro";
import DogMainFind from "@/page/finder/FindDogPage.astro";
...
export const ROUTE_MAP: Record<string, any> = {
    default: { view: Home, description: "홈 페이지입니다." },
    인증: {
        로그인: {
            view: Sign,
            isLogin: true,
    ...
    마이보드: { view: MyBoard, description: "마이보드 페이지입니다." },
    검색: { view: Search, description: "통합 검색 페이지입니다." },
    쇼츠: { view: Shorts, description: "쇼츠 페이지입니다." },
    쇼핑: {
        DEFAULT: { view: Shop, description: "쇼핑몰 메인" },
        음식: { view: Food, description: "사료 및 먹거리" },
        간식: { view: Snack, description: "수제 간식" },
        장난감: { view: Toy, description: "장난감 모음" },
        용품: { view: Supplies, description: "필수 반려용품" },
        의류: { view: Clothing, description: "반려동물 의류" }
    },
    파인더: {
        DEFAULT: { view: Find, description: "파인더 메인" },
        강아지: {
            DEFAULT: { view: DogMainFind, description: "강아지 통합 목록" },
            찾기: { view: DogFind, description: "실종 강아지 찾기" },
            입양: { view: DogAdopt, description: "강아지 입양" },
            보호: { view: DogPickup, description: "강아지 보호" }
        },
        고양이: {
            DEFAULT: { view: CatMainFind, description: "고양이 통합 목록" },
            찾기: { view: CatFind, description: "실종 고양이 찾기" },
            입양: { view: CatAdopt, description: "고양이 입양" },
            보호: { view: CatPickup, description: "고양이 보호" }
        }
    }
};
